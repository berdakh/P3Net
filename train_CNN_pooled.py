...
for itemname, filename in dname.items():
    ...
    for values in itertools.product(*map(params.get, keys)):     
        ...
        description = 'C{}_K{}'.format(d['conv_channels'], 
                        d['kernel_size'][:len(d['conv_channels'])])    
        print('\n\n##### ' + description + ' #####')
