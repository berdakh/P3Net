...
class EEGDataLoader(object):         
    ...
    def load_pooled(self, subjectIndex):         
        ...
        try:
            if b[0]['pos']: target, nontarget = 'pos', 'neg'
        ...
        x_train, x_valid, y_train, y_valid =\
            train_test_split(x_rest, y_rest, test_size = 0.25, random_state = 42, stratify = y_rest)            
...
#%%     UPSAMPLING after split / x_test is left out without upsampling             
        ...
        y_train, y_valid, y_test = map(torch.LongTensor,  (y_train, y_valid, y_test))        
    ...
    def subject_specific(self, subjectIndex):  
       ...
       # filetype is used for correct indexing in NU and MOABB datasets 
        ...
        for ii in range(len(pos)):              
            ...
            x_train, x_valid, y_train, y_valid =\
                train_test_split(x_rest, y_rest, test_size = 0.2, random_state = 42, stratify = y_rest)                   
